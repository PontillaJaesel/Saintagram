export const TEMPORARY_ACCOUNT_NAMES = [
  ...
  "Ximena Guzman", "Yadhira Carrillo", "Yahir Yanez- V.", "Yesmin Aguilera", "Andrea Mandujano", "Yovana Valerio", "Sara Muralles",
  "Humberto Gonzalez", "Lorena Grajeda", "Irahis Cisneros", "Adelaida Moreno", "Oscar Orozco"
];

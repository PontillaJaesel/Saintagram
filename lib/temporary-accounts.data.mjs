export const TEMPORARY_ACCOUNT_NAMES = [
  ...
  "Sonia Perez", "Victoria Palacios", "Yesenia Rodriguez", "Jaesel Pontilla"
];

export const TEMPORARY_ACCOUNTS = [
  ...TEMPORARY_ACCOUNT_NAMES.map((fullName, index) => {
    const code = String(index + 1).padStart(3, "0");
    return { fullName, username: `USR${code}`, temporaryPassword: `Serve@${code}`, role: "user" };
  }),
  { fullName: "Saintagram Replacement Test User", username: "USRTEST3", temporaryPassword: "NewTemp3@2026", role: "tester" },
  { fullName: "Test User 1", username: "USRTEST1", temporaryPassword: "NewTemp1@2026", role: "tester" },
  { fullName: "Saintagram Alternate Test User", username: "USRTEST2", temporaryPassword: "NewTemp2@2026", role: "tester" }
];

...
const firebaseConfig = {
  apiKey:
    ...
    "AIzaSyBPI__TDo06VKvWOmGxQjDagOcsdoLmTko",
  authDomain:
    process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN ??
    "saintagram-51ccc.firebaseapp.com",
  projectId:
    process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID ?? "saintagram-51ccc",
  messagingSenderId:
    process.env.NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID ?? "1045750502235",
  appId:
    process.env.NEXT_PUBLIC_FIREBASE_APP_ID ??
    "1:1045750502235:web:04902ace84ed9ee912807e"
};

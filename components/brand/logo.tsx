  ...
  return (
    ...
    >
      <span className="relative grid size-9 place-items-center rounded-xl bg-sage-700 text-white shadow-sm">
        <span
          className="absolute h-5 w-0.5 rounded-full bg-gold-200"
          aria-hidden="true"
        />
        <span
          className="absolute h-0.5 w-5 rounded-full bg-gold-200"
          aria-hidden="true"
        />
        <Sparkles
          className="absolute -right-1 -top-1 size-3.5 text-gold-500"
          fill="currentColor"
          aria-hidden="true"
        />
      </span>
